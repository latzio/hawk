...
public:
	GameController() { std::memset(this, 0, sizeof(GameController)); }
...
public:
    ...
    virtual void onControlStarted(HawkControl) = 0;
    virtual void onControlStopped(HawkControl) = 0;

protected:
    virtual ~HawkInputHandler() {};
};
...
public:
    ...
    void loadController(GameController*);
     ...
     */
    HawkInputHandler* setEventHandler(HawkInputHandler* handler);
...
private:
    ...
    enum { MaxControllers = 2 };
    GameController m_controllers[MaxControllers];

    HawkInputHandler* m_handler;
